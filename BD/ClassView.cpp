...
BEGIN_MESSAGE_MAP(CClassView, CDockablePane)
	...
	ON_COMMAND(IDR_COM, OnClickComboBox)
	ON_CBN_SELCHANGE(IDR_COM, OnSelChangeClick)
END_MESSAGE_MAP()
...
int CClassView::OnCreate(LPCREATESTRUCT lpCreateStruct)
{
	...
	m_ComboButton = new CMFCToolBarComboBoxButton(IDR_COM, ::GetCmdMgr()->GetCmdImage(IDR_COM, FALSE), CBS_DROPDOWN, 120);
	m_ComboButton->EnableWindow(true);
	m_ComboButton->SetCenterVert();
	m_ComboButton->SetDropDownHeight(200);
...
void CClassView::OnSelChangeClick()
{
...
void CClassView::OnClickComboBox()
{
}